...
func (ps PieceSet) GetOrientationCount(pieceIdx int) int {
	return ps.piecePermutations[pieceIdx].Len()
}
...
func (ps *PieceSet) createAllPermutations() {
	...
	// *****
	l1.PushFront(NewPiece(1, 5, 1, 'A', []uint8{0x1f}, map[int]bool{10: true, 15: true, 40: true, 45: true}))
	...
	// *
	// *
	l1.PushFront(NewPiece(1, 1, 5, 'A', []uint8{0x1, 0x1, 0x1, 0x1, 0x1}, map[int]bool{1: true, 8: true, 51: true, 58: true}))
